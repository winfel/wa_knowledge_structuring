...
NumericObject.draw = function(external) {
  // this representation
...
NumericObject.createRepresentation = function(parent) {
  var rep = GUI.svg.other(parent, "foreignObject");

  rep.dataObject = this;

  var body = document.createElement("body");
  $(body).html('<div style="display: table; width: 100%;">'
...
NumericObject.updateInnerHeight = function() {
  var rep = this.getRepresentation();
...
NumericObject.adjustControls = function() {
  this.updateInnerHeight();
