...
NumberCreator.dblclickHandler = function(event) {
  GeneralObject.dblclickHandler.call(this, event);

  this.performAction("createNumericObject", this);
};

NumberCreator.draw = function(external) {
  // this representation
  ...
  $(rep).find("body>div>div").html(this.getAttribute("value"));
...
NumberCreator.updateInnerHeight = function() {
  var rep = this.getRepresentation();
...
NumberCreator.createRepresentation = function(parent) {
...
NumberCreator.adjustControls = function() {
  this.updateInnerHeight();
