...
ObjectManager.getObject = function (roomID, objectID, context, callback) {
  ...
  if (!callback)
    throw new Error('Missing callback in ObjectManager.getObject');
  ...
  Modules.Connector.createObject(roomID, type, merged, context, function (id) {
    ...
    ObjectManager.getObject(roomID, id, context, function (object) {
      ...
      Modules.RightManager.getObjectRights(object, function (rights) {
        ...
        // Check if the right manager is supported. Otherwise no manager role is required...
        ...
        // Now the manager role is setup. Proceed with the rest.
